...
class NewslettersController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $articles = Articles::where('newsletter_id', $id)->get();
    ...
    public function update(Request $request, Newsletter $newsletter)
    {
        ...
        $newsletter->Author = $request->get('Author');
        $newsletter->Description = $request->get('Description');
        $newsletter->Status = $request->get('Status');
        $newsletter->save();
        return redirect()
            ->route('newsletters.index')
    ...
    //     $newsletters = Articles::select("SELECT * FROM Articles WHERE Title LIKE '%{$query}%' OR Content LIKE '%{$query}%'");

    //     return view('search', ['Articles' => $newsletters]);
    // }
