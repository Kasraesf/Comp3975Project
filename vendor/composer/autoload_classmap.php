...
return array(
    ...
    'App\\Http\\Controllers\\NewslettersController' => $baseDir . '/app/Http/Controllers/NewslettersController.php',
    ...
    'Tonysm\\GlobalId\\Commands\\GlobalIdCommand' => $vendorDir . '/tonysm/globalid-laravel/src/Commands/GlobalIdCommand.php',
    'Tonysm\\GlobalId\\Exceptions\\GlobalIdException' => $vendorDir . '/tonysm/globalid-laravel/src/Exceptions/GlobalIdException.php',
    'Tonysm\\GlobalId\\Exceptions\\InvalidSignatureException' => $vendorDir . '/tonysm/globalid-laravel/src/Exceptions/InvalidSignatureException.php',
    'Tonysm\\GlobalId\\Exceptions\\LocatorException' => $vendorDir . '/tonysm/globalid-laravel/src/Exceptions/LocatorException.php',
    'Tonysm\\GlobalId\\Exceptions\\MissingVerifierException' => $vendorDir . '/tonysm/globalid-laravel/src/Exceptions/MissingVerifierException.php',
    'Tonysm\\GlobalId\\Exceptions\\SignedGlobalIdException' => $vendorDir . '/tonysm/globalid-laravel/src/Exceptions/SignedGlobalIdException.php',
    'Tonysm\\GlobalId\\Facades\\Locator' => $vendorDir . '/tonysm/globalid-laravel/src/Facades/Locator.php',
    'Tonysm\\GlobalId\\GlobalId' => $vendorDir . '/tonysm/globalid-laravel/src/GlobalId.php',
    'Tonysm\\GlobalId\\GlobalIdServiceProvider' => $vendorDir . '/tonysm/globalid-laravel/src/GlobalIdServiceProvider.php',
    'Tonysm\\GlobalId\\Locator' => $vendorDir . '/tonysm/globalid-laravel/src/Locator.php',
    'Tonysm\\GlobalId\\Locators\\BaseLocator' => $vendorDir . '/tonysm/globalid-laravel/src/Locators/BaseLocator.php',
    'Tonysm\\GlobalId\\Locators\\LocatorContract' => $vendorDir . '/tonysm/globalid-laravel/src/Locators/LocatorContract.php',
    'Tonysm\\GlobalId\\Models\\HasGlobalIdentification' => $vendorDir . '/tonysm/globalid-laravel/src/Models/HasGlobalIdentification.php',
    'Tonysm\\GlobalId\\SignedGlobalId' => $vendorDir . '/tonysm/globalid-laravel/src/SignedGlobalId.php',
    'Tonysm\\GlobalId\\URI\\GID' => $vendorDir . '/tonysm/globalid-laravel/src/URI/GID.php',
    'Tonysm\\GlobalId\\URI\\GIDParsingException' => $vendorDir . '/tonysm/globalid-laravel/src/URI/GIDParsingException.php',
    'Tonysm\\GlobalId\\Verifier' => $vendorDir . '/tonysm/globalid-laravel/src/Verifier.php',
    'Tonysm\\RichTextLaravel\\Actions\\FragmentByCanonicalizingAttachmentGalleries' => $vendorDir . '/tonysm/rich-text-laravel/src/Actions/FragmentByCanonicalizingAttachmentGalleries.php',
    'Tonysm\\RichTextLaravel\\Actions\\FragmentByCanonicalizingAttachments' => $vendorDir . '/tonysm/rich-text-laravel/src/Actions/FragmentByCanonicalizingAttachments.php',
    'Tonysm\\RichTextLaravel\\AttachableFactory' => $vendorDir . '/tonysm/rich-text-laravel/src/AttachableFactory.php',
    'Tonysm\\RichTextLaravel\\Attachables\\Attachable' => $vendorDir . '/tonysm/rich-text-laravel/src/Attachables/Attachable.php',
    'Tonysm\\RichTextLaravel\\Attachables\\AttachableContract' => $vendorDir . '/tonysm/rich-text-laravel/src/Attachables/AttachableContract.php',
    'Tonysm\\RichTextLaravel\\Attachables\\ContentAttachment' => $vendorDir . '/tonysm/rich-text-laravel/src/Attachables/ContentAttachment.php',
    'Tonysm\\RichTextLaravel\\Attachables\\MissingAttachable' => $vendorDir . '/tonysm/rich-text-laravel/src/Attachables/MissingAttachable.php',
    'Tonysm\\RichTextLaravel\\Attachables\\RemoteFile' => $vendorDir . '/tonysm/rich-text-laravel/src/Attachables/RemoteFile.php',
    'Tonysm\\RichTextLaravel\\Attachables\\RemoteImage' => $vendorDir . '/tonysm/rich-text-laravel/src/Attachables/RemoteImage.php',
    'Tonysm\\RichTextLaravel\\Attachment' => $vendorDir . '/tonysm/rich-text-laravel/src/Attachment.php',
    'Tonysm\\RichTextLaravel\\AttachmentGallery' => $vendorDir . '/tonysm/rich-text-laravel/src/AttachmentGallery.php',
    'Tonysm\\RichTextLaravel\\Attachments\\Minification' => $vendorDir . '/tonysm/rich-text-laravel/src/Attachments/Minification.php',
    'Tonysm\\RichTextLaravel\\Attachments\\TrixConvertion' => $vendorDir . '/tonysm/rich-text-laravel/src/Attachments/TrixConvertion.php',
    'Tonysm\\RichTextLaravel\\Casts\\AsRichTextContent' => $vendorDir . '/tonysm/rich-text-laravel/src/Casts/AsRichTextContent.php',
    'Tonysm\\RichTextLaravel\\Casts\\ForwardsAttributeToRelationship' => $vendorDir . '/tonysm/rich-text-laravel/src/Casts/ForwardsAttributeToRelationship.php',
    'Tonysm\\RichTextLaravel\\Commands\\RichTextLaravelInstallCommand' => $vendorDir . '/tonysm/rich-text-laravel/src/Commands/RichTextLaravelInstallCommand.php',
    'Tonysm\\RichTextLaravel\\Content' => $vendorDir . '/tonysm/rich-text-laravel/src/Content.php',
    'Tonysm\\RichTextLaravel\\Exceptions\\RichTextException' => $vendorDir . '/tonysm/rich-text-laravel/src/Exceptions/RichTextException.php',
    'Tonysm\\RichTextLaravel\\Fragment' => $vendorDir . '/tonysm/rich-text-laravel/src/Fragment.php',
    'Tonysm\\RichTextLaravel\\HtmlConversion' => $vendorDir . '/tonysm/rich-text-laravel/src/HtmlConversion.php',
    'Tonysm\\RichTextLaravel\\LivewireSupportsRichText' => $vendorDir . '/tonysm/rich-text-laravel/src/LivewireSupportsRichText.php',
    'Tonysm\\RichTextLaravel\\Livewire\\WithRichTexts' => $vendorDir . '/tonysm/rich-text-laravel/src/Livewire/WithRichTexts.php',
    'Tonysm\\RichTextLaravel\\Models\\RichText' => $vendorDir . '/tonysm/rich-text-laravel/src/Models/RichText.php',
    'Tonysm\\RichTextLaravel\\Models\\Traits\\HasRichText' => $vendorDir . '/tonysm/rich-text-laravel/src/Models/Traits/HasRichText.php',
    'Tonysm\\RichTextLaravel\\PlainTextConversion' => $vendorDir . '/tonysm/rich-text-laravel/src/PlainTextConversion.php',
    'Tonysm\\RichTextLaravel\\RichTextLaravelServiceProvider' => $vendorDir . '/tonysm/rich-text-laravel/src/RichTextLaravelServiceProvider.php',
    'Tonysm\\RichTextLaravel\\Serialization' => $vendorDir . '/tonysm/rich-text-laravel/src/Serialization.php',
    'Tonysm\\RichTextLaravel\\TrixAttachment' => $vendorDir . '/tonysm/rich-text-laravel/src/TrixAttachment.php',
    'Tonysm\\RichTextLaravel\\View\\Components\\TrixStyles' => $vendorDir . '/tonysm/rich-text-laravel/src/View/Components/TrixStyles.php',
